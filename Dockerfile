...
ENTRYPOINT [ "java", "-javaagent:./elastic-apm-agent.jar", "-Delastic.apm.service_name=bank", "-Delastic.apm.server_url=http://118.67.143.99:8200", "-Delastic.apm.application_packages=com.ms.*", "-Delastic.apm.transaction_sample_rate=1", "-Delastic.apm.enable_log_correlation=true", "-Delastic.apm.span_frames_min_duration=1ms", "-Delastic.apm.span_min_duration=0ms", "-Delastic.apm.trace_methods_duration_threshold=1ms", "-Delastic.apm.trace_methods=com.ms.*", "-jar", "/bank.jar"]
